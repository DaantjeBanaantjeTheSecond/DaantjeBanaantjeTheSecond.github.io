...
if (getCookie("playInternetCafe") == "true") {
    startInternetCafe();
    setCookie("playInternetCafe", false, .1);
}

function startInternetCafe() {
...
function startInternetCafeHomePage() {
    setCookie("playInternetCafe", true, .1);
